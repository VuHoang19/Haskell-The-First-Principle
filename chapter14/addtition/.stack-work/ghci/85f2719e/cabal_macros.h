...
/* package addtition-0.1.0.0 */
#ifndef VERSION_addtition
#define VERSION_addtition "0.1.0.0"
#endif /* VERSION_addtition */
#ifndef MIN_VERSION_addtition
#define MIN_VERSION_addtition(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_addtition */
...
#define CURRENT_COMPONENT_ID "addtition-0.1.0.0-DuPoa768nvzDzm0nrTIBRc-addtition"
